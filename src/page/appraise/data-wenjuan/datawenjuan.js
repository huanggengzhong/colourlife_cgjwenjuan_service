  ...
  render() {
    ...
    const columns = [
      ...
      },
      {
        ...
        fixed: 'right',
        render: (item, record) => (
          <a onClick={this.toDetail.bind(this, item)}>查看</a>
        )
      }
    ]
    return (
      <div className="show">
        ...
        <div className="search_box" style={{ position: 'relative' }}>
          ...
          {/* 我增加的 */}
          <div className="dajuanDownload">
            <Dropdown overlay={menu}>
              <Button type="primary">
              下载答卷数据 <Icon type="down" />
              </Button>
            </Dropdown>
        ...
        <div className="total_box">
          <p className="name">
            用户整体好评率：
            <span className="val">
              {this.tofixed(this.state.totalhpDegree)}
            </span>
          </p>
          <p className="name">
            用户整体满意度：
            <span className="val">
              {this.tofixed(this.state.totalmyDegree)}
            </span>
          </p>
        </div>
